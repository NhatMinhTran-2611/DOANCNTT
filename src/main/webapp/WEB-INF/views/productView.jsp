      ...
      <main class="col-md-7">
        ...
        <dl class="row mb-4">
          ...
          <table class="table table-bordered table-striped">
            ...
            <tr>
              <th scope="row">RAM</th>
              <td>${requestScope.product.RAM}</td>
            </tr>
            <tr>
              <th scope="row">CPU</th>
            ...
            <tr>
              <th scope="row">VGA</th>
              <td>${requestScope.product.VGA}</td>
            </tr>
            <tr>
              <th scope="row">OS</th>
            ...
            <tr>
              <th scope="row">SSD</th>
              <td>${requestScope.product.SSD}</td>
            </tr>
            <tr>
              <th scope="row">Màn hình</th>
              <td>${requestScope.product.screenSize} inch</td>
            </tr>
            <tr>
              <th scope="row">Trọng lượng</th>
              <td>${requestScope.product.weight} kg</td>
            </tr>
            </tbody>
          </table>
